...
#### Package Manager:
```ps
Install-Package Excubo.Analyzers.DependencyInjectionValidation -Version 1.0.7
Install-Package Excubo.Analyzers.Annotations -Version 1.0.5
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Analyzers.DependencyInjectionValidation --version 1.0.7
