...
#### Package Manager:
```ps
Install-Package Excubo.Analyzers.DependencyInjectionValidation -Version 1.0.3
Install-Package Excubo.Analyzers.Annotations -Version 1.0.3
```

#### .NET Cli:
```cmd
dotnet add package Excubo.Analyzers.DependencyInjectionValidation --version 1.0.3
dotnet add package Excubo.Analyzers.Annotations --version 1.0.3
```
