...
namespace Types
{
    ...
    #endregion
    public class DependingOnServiceInPrivateConstructor<U1, U2> : IPublicUse1<U1> // cannot be constructed freely, but also cannot be exposed with service extension
    {
        private DependingOnServiceInPrivateConstructor(IPublicUse2<U1, U2> internal_service)
        {
