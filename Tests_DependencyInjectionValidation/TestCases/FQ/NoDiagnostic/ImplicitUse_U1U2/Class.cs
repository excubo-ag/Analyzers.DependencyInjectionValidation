...
namespace Types
{
    ...
    #endregion
    internal class ImplicitUse<U1, U2> : IPublicUse1<U1, U2> // must be exposed through service extension
    {
    }
    public static class ServiceExtension
    {
        [Exposes(typeof(ImplicitUse<,>)), As(typeof(IPublicUse1<,>))]
        public static IServiceCollection AddService<V>(this IServiceCollection services)
        {
            return services
                .AddSingleton<IPublicUse1<string, V>, ImplicitUse<string, V>>();
        }
    }
}
